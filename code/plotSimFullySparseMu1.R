...
pdf(file = paste0('plot/sim/fully_sparse/', dname, '_rbf.pdf'), width = 14, height = 6)
plotFdata(fdata1$id, fdata1$t, fdata1$y)
...
pdf(file = paste0('plot/sim/fully_sparse/', dname, '_lap.pdf'), width = 14, height = 6)
plotFdata(fdata1$id, fdata1$t, fdata1$y)
lines(testTime, muf1(testTime), lwd = 4)
...
pdf(file = paste0('plot/sim/fully_sparse/', dname, '_m52.pdf'), width = 14, height = 6)
plotFdata(fdata1$id, fdata1$t, fdata1$y)
lines(testTime, muf1(testTime), lwd = 4)
...
pdf(file = paste0('plot/sim/fully_sparse/', dname, '_m32.pdf'), width = 14, height = 6)
plotFdata(fdata1$id, fdata1$t, fdata1$y)
lines(testTime, muf1(testTime), lwd = 4)
